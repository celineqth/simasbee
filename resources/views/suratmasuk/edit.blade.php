...
@if($errors->has('nosurat')) is-invalid @endif" placeholder="Masukkan No.Surat" value="{{$suratmasuk->no_surat}}">
...
@if($errors->has('tglsurat')) is-invalid @endif" placeholder="Masukkan Tgl. Surat" value="{{$suratmasuk->tgl_surat}}">
...
@if($errors->has('tglmasuk')) is-invalid @endif" placeholder="Masukkan Tgl. Masuk" value="{{$suratmasuk->tgl_masuk}}">
...
@if($errors->has('pengirim')) is-invalid @endif" placeholder="Masukkan Pengirim Surat" value="{{$suratmasuk->pengirim}}">
