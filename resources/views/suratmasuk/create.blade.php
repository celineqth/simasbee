...
@if($errors->has('nosurat')) is-invalid @endif" placeholder="Masukkan No.Surat" value="{{old('nosurat')}}">
...
@if($errors->has('pengirim')) is-invalid @endif" placeholder="Masukkan Pengirim Surat" value="{{old('pengirim')}}">
