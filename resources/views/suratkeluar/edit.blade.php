...
@if($errors->has('nosurat')) is-invalid @endif" placeholder="Masukkan No.Surat" value="{{$suratkeluar->no_surat}}">
...
@if($errors->has('tglsurat')) is-invalid @endif" placeholder="Masukkan Tgl. Surat" value="{{$suratkeluar->tgl_surat}}">
...
@if($errors->has('tglkeluar')) is-invalid @endif" placeholder="Masukkan Tgl. Keluar" value="{{$suratkeluar->tgl_keluar}}">
...
@if($errors->has('tujuan')) is-invalid @endif" placeholder="Masukkan Tujuan Surat" value="{{$suratkeluar->tujuan}}">
